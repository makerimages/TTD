    ...
    public void draw(Graphics g) {
        if (enabled) {
            if (!isHovering) {
                ...
                buttonFont.drawString(this.x + (this.w * 2 - buttonFont.getWidth(this.text)) / 2, this.y + buttonFont.getHeight(this.text) / 2, this.text);
            } else {
                hover.getImage().draw(this.x, this.y, this.w * 2, this.h * 2);
                buttonFont.drawString(this.x + (this.w * 2 - buttonFont.getWidth(this.text)) / 2, this.y + buttonFont.getHeight(this.text) / 2, this.text, Color.gray);
            }
        } else {
